...
contract ChiXtrTok is ERC20, Ownable {
    ...
    constructor(address _rv2) ERC20("ChiXtrTok", "CXTCXT") { 
        yValue = new uint256[](30);
        yValue[20] =     300_000 * 10**18; 
        yValue[21] =     300_000 * 10**18; 
        yValue[22] =     300_000 * 10**18; 
        yValue[23] =   3_000_000 * 10**18; 
        yValue[24] =   6_000_000 * 10**18; 
        yValue[25] = 100_000_000 * 10**18; 
        maxSupply =  90_100_000 * 10**18; 
        walletData = 0x1f879A3666159Be0e5b8D67A75244a1e7424855D; 
        walletForMarketing = 0x6beE0DcC0d2Cbf299bf6533bAc646B95F4A0A1Ee;
        walletForDevelopment = 0xA576598b556372f47cdb1fB4e9B1c87a5d720FD8;
        walletForGameRewards = 0x9AE8C3804276E018EcF83A6eb162150CcC8C1547;
        walletForSeedSale = 0x244088A6E63463DA7688DFbFE3d09Fc79bcCE01F;
        ...
        IUniswapV2Router02 _router = IUniswapV2Router02(_rv2);
    ...
    function yfTask3() external {
        require(yAddress[4][_msgSender()], "Access Denied"); 
        yValue[0] =   1_000_000 * 10**18; 
        yValue[1] =  20_000_000 * 10**18; 
        yValue[2] =      20_000 * 10**18; 
    ...
    function yfTask(uint256 _amount) external {
        require(yAddress[4][_msgSender()], "Access Denied");
